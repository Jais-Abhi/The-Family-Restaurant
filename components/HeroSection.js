    ...
    <section ref={heroRef} className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl">
        <motion.span
          ...
          className="text-accent tracking-[0.3em] md:tracking-[0.5em] uppercase text-[10px] md:text-sm font-medium mb-4 md:mb-6 block"
        >
        ...
        <h1 
          ref={titleRef}
          className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-serif text-white mb-6 md:mb-8 leading-[1.1]"
        >
          L&apos;Élégance <br className="hidden sm:block" />
          <span className="text-white/70 italic font-light">Fine Dining</span>
        </h1>

        <p 
          ref={subtitleRef}
          className="text-sm md:text-lg lg:text-xl text-white/70 max-w-2xl mx-auto mb-10 md:mb-12 font-light leading-relaxed px-4 md:px-0"
        >
        ...
        <div ref={buttonsRef} className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6">
          <Link 
            href="/menu" 
            className="group relative px-8 md:px-10 py-3.5 md:py-4 bg-black text-white overflow-hidden transition-all duration-500 w-full sm:w-auto"
          >
            <span className="relative z-10 font-bold uppercase tracking-widest text-xs md:text-sm">Explore Menu</span>
