...
export default function RestaurantStory() {
  return (
    <section className="py-16 md:py-24 bg-gray-50 relative overflow-hidden text-black">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <span className="text-accent uppercase tracking-[0.2em] md:tracking-[0.3em] text-[10px] md:text-sm font-semibold mb-4 md:mb-6 block">Our Legacy</span>
          <h2 className="text-3xl md:text-5xl font-serif mb-6 md:mb-8 leading-tight text-black">
          ...
          <Link 
            href="/about" 
            className="mt-10 inline-block px-8 py-3 bg-black text-white font-bold uppercase tracking-widest text-xs hover:bg-accent transition-all duration-300"
          >
            Discover More
          </Link>
        </motion.div>
