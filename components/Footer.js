...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-charcoal text-foreground dark:text-white pt-20 pb-10 border-t border-accent/10">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-foreground/60 dark:text-white/60 leading-relaxed font-light">
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-4 text-foreground/60 dark:text-white/60">
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-4 text-foreground/60 dark:text-white/60">
            <li className="flex items-start space-x-3">
              ...
              <div>
                <p className="font-medium text-foreground dark:text-white">Mon - Fri:</p>
            ...
            <li className="flex items-start space-x-3">
              <Clock size={20} className="text-accent shrink-0 mt-1" />
              <div>
                <p className="font-medium text-foreground dark:text-white">Sat - Sun:</p>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 mt-20 pt-8 border-t border-foreground/5 dark:border-white/5 text-center text-foreground/40 dark:text-white/40 text-sm">
